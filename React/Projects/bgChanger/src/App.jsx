    ...
    <div className="w-full h-screen duration-700 " style={{ backgroundColor: color }}>
      <div className="fixed flex flex-wrap justify-center bottom-14 inset-x-0 ">
        <div className="flex flex-wrap justify-center gap-5 px-3 py-3 rounded-md  bg-white">
          <button
            className="px-3 py-3 w-18 rounded-md text-white "
          ...
          <button
            className=" px-3 py-3 w-18 rounded-md text-black "
          ...
          <button
            className=" px-3 py-3 w-18 rounded-md border-2 text-white "
          ...
          <button
            className=" px-3 py-3 w-18 rounded-md text-black border border-black "
